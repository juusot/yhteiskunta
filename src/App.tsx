...
export const App: React.FC<AppProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    "groups" | "characters" | "buildings" | "rules"
  >("groups");
  ...
  const filteredGroups = useMemo(() => {
    ...
    return groups.filter(
      (g) => g.name.toLowerCase().includes(term) || g.id.toString() === term,
    );
  }, [groups, searchTerm]);
  ...
  const filteredEntities = useMemo(() => {
    ...
    if (searchTerm) {
      ...
      result = result.filter(
        (e) =>
          e.id.toString() === term ||
          e.groups.some((g: number) => g.toString() === term),
      );
    }
    return result;
  ...
  const filteredBuildings = useMemo(() => {
    ...
    if (searchTerm) {
      ...
      result = result.filter(
        (b) =>
          b.id.toString() === term || b.typeName.toLowerCase().includes(term),
      );
    }
    return result;
  ...
  return (
    <div className="fixed inset-0 flex flex-col pointer-events-none">
      ...
      <header className="bg-surface-container-lowest text-on-surface flex justify-between items-center w-full px-margin-lg py-unit h-16 border-b-4 border-on-surface shadow-brutal z-50 pointer-events-auto">
        ...
        <div className="flex items-center gap-4">
          <div className="flex gap-2">
            <BrutalButton
              onClick={() => handleSpeedClick(60, "btn-speed-1")}
              active={tpsSpeed === 60}
            >
              1X
            </BrutalButton>
            <BrutalButton
              onClick={() => handleSpeedClick(120, "btn-speed-2")}
              active={tpsSpeed === 120}
            >
              2X
            </BrutalButton>
            <BrutalButton
              onClick={() => handleSpeedClick(240, "btn-speed-4")}
              active={tpsSpeed === 240}
            >
              4X
            </BrutalButton>
            <BrutalButton
              onClick={() => handleSpeedClick(480, "btn-speed-8")}
              active={tpsSpeed === 480}
            >
              8X
            </BrutalButton>
            <BrutalButton
              onClick={() => handleSpeedClick(0, "btn-speed-max")}
              active={tpsSpeed === 0}
            >
              MAX
            </BrutalButton>
          ...
          <BrutalButton
            onClick={() => document.getElementById("loadBtn")?.click()}
          >
            LOAD
          </BrutalButton>
        </div>
            ...
            footer={
              <>
                <div className="flex gap-6">
                  ...
                  <span>
                    Tick:{" "}
                    <strong className="text-on-surface">{tickCount}</strong>
                  </span>
                  <span>
                    Last: <strong>{lastTickTime.toFixed(1)}ms</strong>
                  </span>
                  <span>
                    ...
                    filteredGroups.map((g) => (
                      ...
                      >
                        <div className="flex justify-between items-start mb-1">
                          <div className="flex items-center gap-2">
                            <div
                              className="w-3 h-3 border border-on-surface"
                              style={{
                                backgroundColor: ARCHETYPE_COLORS[g.id % 4],
                              }}
                            ></div>
                        ...
                        <div className="font-mono text-[13px] text-on-surface-variant">
                          {g.population} Population | {g.buildingCount}{" "}
                          Buildings
                        </div>
                      </div>
                    ))}
                  ...
                  {activeTab === "characters" &&
                    filteredEntities.map((e) => (
                      ...
                      >
                        ...
                        <div className="font-mono text-[13px] text-on-surface-variant">
                          {e.stateName} | Groups: {e.groups.join(", ")}
                        </div>
                      </div>
                    ))}
                  ...
                  <>
                    <div className="flex justify-between items-start border-b-2 border-on-surface pb-4">
                      <div>
                        <h2 className="font-headline text-[32px] font-bold uppercase flex items-center gap-3">
                          <div
                            className="w-6 h-6 border-2 border-on-surface"
                            style={{
                              backgroundColor:
                                ARCHETYPE_COLORS[selectedGroup.id % 4],
                            }}
                          ></div>
                          {selectedGroup.name}
                        </h2>
                        <div className="font-mono text-[13px] text-on-surface-variant mt-1">
                          ID: {selectedGroup.id} | POPULATION:{" "}
                          {selectedGroup.population} | WEALTH:{" "}
                          {selectedGroup.wealth.toLocaleString()}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div className="border-2 border-on-surface bg-surface p-4">
                        <h3 className="font-mono text-[12px] font-bold uppercase mb-4 border-b border-on-surface pb-1">
                          Resources
                        </h3>
                      ...
                      <div className="border-2 border-on-surface bg-surface p-4 flex flex-col">
                        <h3 className="font-mono text-[12px] font-bold uppercase mb-2 border-b border-on-surface pb-1">
                          Recent Chronicle
                        </h3>
                        <div className="flex-1 overflow-y-auto text-[10px] font-mono space-y-1">
                          {chronicle.slice(0, 10).map((line, i) => (
                            <div
                              key={i}
                              className="border-b border-surface-variant pb-1"
                            >
                              {line}
                            </div>
                          ))}
                    ...
                    <div className="border-2 border-on-surface bg-surface p-4">
                      <h3 className="font-mono text-[12px] font-bold uppercase mb-4 border-b border-on-surface pb-1 text-on-surface">
                      ...
                      <div className="max-h-48 overflow-y-auto">
                        <BrutalTable
                          ...
                          rows={groupMembers
                            .slice(0, 20)
                            .map((m) => [`#${m.id}`, m.stateName, m.health])}
                        />
                      </div>
                    </div>
                  </>
                      ...
                      <div>
                        <h2 className="font-headline text-[32px] font-bold uppercase flex items-center gap-3">
                          <div
                            ...
                            style={{
                              backgroundColor:
                                ARCHETYPE_COLORS[selectedEntity.faction % 4],
                            }}
                          ></div>
                          ENTITY {selectedEntity.id}
                        </h2>
                        <div className="font-mono text-[13px] text-on-surface-variant mt-1 uppercase font-bold">
                          STATE: {selectedEntity.stateName} | POS: (
                          {Math.round(selectedEntity.positionX)},{" "}
                          {Math.round(selectedEntity.positionY)})
                        </div>
                      </div>
                      <div className="flex gap-2">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div className="border-2 border-on-surface bg-surface p-4 text-on-surface">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center gap-2">
                            <span className="text-[11px] font-bold w-12 uppercase">
                              Health
                            </span>
                            <div className="flex-1 h-4 bg-surface-container border border-on-surface relative">
                              <div
                                className="absolute inset-0 bg-secondary transition-all"
                                style={{
                                  width: `${(selectedEntity.health / 100) * 100}%`,
                                }}
                              ></div>
                              <span className="absolute inset-0 flex items-center justify-center text-[10px] font-bold text-on-secondary mix-blend-difference">
                                {selectedEntity.health}/100
                              </span>
                            </div>
                          </div>
                          <div className="grid grid-cols-3 gap-2 text-center">
                            <div className="bg-surface-container border border-on-surface p-1">
                              ...
                              <div className="font-bold">
                                {selectedEntity.effectiveDamage}
                              </div>
                            </div>
                            <div className="bg-surface-container border border-on-surface p-1">
                              <div className="text-[9px] text-on-surface-variant uppercase">
                              ...
                              <div className="font-bold">
                                {selectedEntity.effectiveSpeed.toFixed(1)}
                              </div>
                            </div>
                            <div className="bg-surface-container border border-on-surface p-1">
                              <div className="text-[9px] text-on-surface-variant uppercase">
                              ...
                              <div className="font-bold">
                                {selectedEntity.effectiveLifespan}
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="border-2 border-on-surface bg-surface p-4 text-on-surface">
                        ...
                        <div className="space-y-1 overflow-y-auto max-h-32">
                          {selectedEntity.groups.map((gid, i) => (
                            <div
                              key={i}
                              className="flex justify-between items-center text-[11px] font-mono border-b border-surface-variant pb-1 last:border-0"
                            >
                              <span>Slot {i}</span>
                  ...
                  <>
                    <div className="flex justify-between items-start border-b-2 border-on-surface pb-4">
                      <div>
                        ...
                        <div className="font-mono text-[13px] text-on-surface-variant mt-1 uppercase font-bold">
                          ID: {selectedBuilding.id} | OWNER: Group{" "}
                          {selectedBuilding.ownerGroup}
                        </div>
                      </div>
                    </div>
                    <div className="border-2 border-on-surface bg-surface p-4 text-on-surface">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1 h-6 bg-surface-container border border-on-surface relative">
                          <div
                            className="absolute inset-0 bg-tertiary transition-all"
                            style={{
                              width: `${(selectedBuilding.health / selectedBuilding.maxHealth) * 100}%`,
                            }}
                          ></div>
                          <span className="absolute inset-0 flex items-center justify-center text-[12px] font-bold text-on-tertiary mix-blend-difference">
      ...
      <footer className="bg-on-surface text-surface fixed bottom-0 left-0 w-full z-50 flex justify-between items-center px-margin-md py-1 h-8 border-t-2 border-surface-variant font-mono text-[11px] pointer-events-auto">
        <div className="flex items-center gap-4">
          <span>
            TICK_RATE: {(1000 / avgTickTime).toFixed(0)} | LATENCY:{" "}
            {lastTickTime.toFixed(1)}ms | AVG: {avgTickTime.toFixed(1)}ms
          </span>
...
const RulesTab: React.FC<{
    ...
    for (let i = 0; i < 20; i++) {
      ...
      if (ruleRegistry[base + 2] === 255) {
        ...
        for (let j = 0; j < 32; j++) {
          ...
          if (op === 255) break;
          if (op === 0 || op === 1)
            nodes.push({ op, val: logicBytecode[lBase + ++j] });
          else if (op === 2)
            nodes.push({
              op,
              val: logicBytecode[lBase + ++j],
              val2: logicBytecode[lBase + ++j],
            });
          else if (op === 3)
            nodes.push({
              op,
  ...
  const compileRule = (ruleIdx: number, nodes: any[]) => {
    ...
    for (const n of nodes) {
      ...
      if (n.op === 0 || n.op === 1) logicBytecode[base + ptr++] = n.val;
        ...
        logicBytecode[base + ptr++] = n.val;
        logicBytecode[base + ptr++] = n.val2 || 0;
      } else if (n.op === 3) {
        logicBytecode[base + ptr++] = n.val;
        logicBytecode[base + ptr++] = n.val2 || 0;
        logicBytecode[base + ptr++] = n.val3 || 0;
      }
    }
  ...
  const updateRule = (index: number, field: string, value: any) => {
    ...
    switch (field) {
      case "subjectId":
        ruleRegistry[base + 1] = value;
        break;
      case "conditionType":
        ruleRegistry[base + 2] = value;
        break;
      case "threshold":
        ruleRegistry[base + 3] = value;
        break;
      case "actionState":
        ruleRegistry[base + 4] = value;
        break;
      case "targetX":
        ruleRegistry[base + 5] = value;
        break;
      case "targetY":
        ruleRegistry[base + 6] = value;
        break;
      case "enabled":
        ruleRegistry[base + 7] = value ? 1 : 0;
        break;
      case "nodes":
        compileRule(index, value);
        break;
    }
    setRules((prev) =>
  ...
  const filteredRules = searchTerm
    ? rules.filter(
        (_, i) =>
          i.toString() === searchTerm ||
          rules[i].subjectId.toString() === searchTerm,
      )
    : rules;
    ...
    <div className="w-full flex flex-col h-full bg-surface-container-lowest text-on-surface">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {filteredRules.map((r) => (
          <div
            key={r.index}
            className="bg-surface border-2 border-on-surface p-4 shadow-brutal-sm"
          >
            <div className="flex items-center justify-between mb-3 border-b border-on-surface pb-1 text-on-surface">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  checked={r.enabled}
                  onChange={(e) =>
                    updateRule(r.index, "enabled", e.target.checked)
                  }
                  className="accent-on-surface w-4 h-4 rounded-none border-2 border-on-surface bg-surface"
                />
              </div>
              <div className="text-[11px] font-mono text-on-surface-variant uppercase font-bold">
                Subject Group: {r.subjectId}
              </div>
            </div>
            <div className="grid grid-cols-4 gap-4 mb-4 text-[11px] font-mono text-on-surface">
              <div>
                ...
                <select
                  value={r.actionState}
                  onChange={(e) =>
                    updateRule(r.index, "actionState", parseInt(e.target.value))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  value={r.threshold}
                  onChange={(e) =>
                    updateRule(r.index, "threshold", parseInt(e.target.value))
                  }
                  className="w-full border-2 border-on-surface bg-surface px-1 py-0.5 text-on-surface"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  value={r.targetX}
                  onChange={(e) =>
                    updateRule(r.index, "targetX", parseInt(e.target.value))
                  }
                  className="w-full border-2 border-on-surface bg-surface px-1 py-0.5 text-on-surface"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  value={r.targetY}
                  onChange={(e) =>
                    updateRule(r.index, "targetY", parseInt(e.target.value))
                  }
                  className="w-full border-2 border-on-surface bg-surface px-1 py-0.5 text-on-surface"
                />
              </div>
            ...
            <div className="flex flex-wrap gap-2 text-on-surface">
              {r.nodes.map((n: any, ni: number) => (
                <div
                  key={ni}
                  className="flex items-center gap-1 bg-surface-container border border-on-surface px-2 py-1 text-[11px] font-mono"
                >
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const next = [...r.nodes];
                      next[ni] = { ...next[ni], val: parseInt(e.target.value) };
              ...
              <BrutalButton
                onClick={() =>
                  updateRule(r.index, "nodes", [...r.nodes, { op: 0, val: 0 }])
                }
                variant="ghost"
                className="border-dashed border-on-surface/30"
              >
                + Add Node
              </BrutalButton>
            </div>
